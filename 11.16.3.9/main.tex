...
\end{enumerate}
\solution 
Let $X_i$ be the random variables where $i = 1,2,3,4$ represents A,B,C,D respectively. 
\begin{align}
X_i &=
	\begin{cases}
	1 & $ selected$\\
...
\pr{X_3 = 1} &= 2\pr{X_4 = 1}
\end{align}
representing all in terms of 1 varible x,
\begin{align}
\pr{X_2 = 1} &= x\\
\pr{X_1 = 1} &= 2x \\
\pr{X_2 = 1} = \pr{X_3 = 1} &= x\\
\pr{X_4 = 1} &= \frac{x}{2}
\end{align}
and we know sum of probabilities of all candidates must be equal to 1 	
\begin{align}
\pr{X_1 = 1}+\pr{X_2 = 1}+\pr{X_3 = 1}+\pr{X_4 = 1} &= 1
\end{align}
So,
\begin{align}
2x + x + x + \frac{x}{2} &= 1\\
\implies \pr{X_2 = 1} &= \frac{2}{9}
\end{align}
\begin{enumerate}
\item 
