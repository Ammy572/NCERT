...
\end{enumerate}
\solution 
Let $X_A,X_B,X_C,X_D$ be the random variables representing A,B,C,D respectively. 
\begin{align}
X_A &=
	\begin{cases}
	1 & $A is selected$\\
...
\begin{align}
\pr{X_A = 1}+\pr{X_B = 1}+\pr{X_C = 1}+\pr{X_D = 1} &= 1
\end{align}
So,
\begin{align}
2x + x + x + \frac{x}{2} &= 1\\
\implies \pr{X_B = 1} &= \frac{2}{9}
\end{align}
\begin{enumerate}
\item 
